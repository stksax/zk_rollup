...
//this template can verify the transcation and generate two list , who get payment for how much, and who spend who much
//and after get this two lists, the template update leaf can generate new leaf of merkle tree
template transcation(n,layer){
    signal input Ax[n];
    signal input Ay[n];
    ...
    //if both sender and reciever's information is correct, the transcation will be accept
    signal is_valid[n];
    for (var i=0;i<n;i++){
