...
describe("transcation test, if the transcation success, the receipt list will add the payment of it", function () {
    let circuit;
    let eddsa;
    let babyJub;
    let F;
    ...
    before( async () => {
        ...
        F = babyJub.F;
        circuit = await wasm_tester(path.join(__dirname, "transcation.circom"));
    ...
    it("Alice withdraw 150, and Bob want to pay 150 to Chris, but his balance isn't enough", async () => {
        ...
        //Alice reduce 150 in her account after she withdraw, Bob and Chris didn't be changed, because Bob's balance isn't enough for transcation 
    ...
    it("Alice save 150 to her account , and Bob want to forgery he had 500 in his account to pay 150 to Chris, but his balance is only 50", async () => {
        ...
        //Alice reduce balance for 150 (300-150) after she withdraw, Bob and Chris didn't be changed, because Bob's balance isn't enough for transcation 
